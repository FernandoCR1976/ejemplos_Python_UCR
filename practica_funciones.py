#Crear un programa que utilizando diccionarios, cree un tarjetero digital. Debe de tener cedula, Nombre, Apellidos, email y telefono. Tendra un Menu que me permita, Ingresar, Modificar u eliminar un Registro. Tambien debo de poder visualizar solamente un contacto buscandolo por su numero de cedula. Tambien puedo hacer un listado de todos los contactos donde solo se imprima, el nombre completo, el telefono y el correo. Todo el software debe de funcionar mediante un menu
